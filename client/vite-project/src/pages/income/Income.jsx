...
const Income = () => {
  ...
  return (
    <div>
      <div className="container d-flex justify-content-center align-items-center min-vh-100 bg-success-subtle">
  <div className="card shadow p-4" style={{ maxWidth: '500px', width: '100%' }}>
    ...
    <form onSubmit={formik.handleSubmit}>
      ...
      <button type="submit" className="btn btn-danger w-100">Record Income</button>
    </form>
  </div>
</div>
